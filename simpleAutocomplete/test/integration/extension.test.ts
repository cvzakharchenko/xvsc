/* tslint:disable */
import { window, Uri, Position, Selection, TextEditor, commands } from 'vscode';
...
describe('Simple Autocomplete', () => {
  ...
  it('does not do anything if the user invokes the command while making a selection', async () => {
    // await _delay(4000)
    const { document, selection } = textEditor;
